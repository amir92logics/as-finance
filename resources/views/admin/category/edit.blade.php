        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang('Category Edit Form')</h1>
                </div>
            </div>
        </div>
                                ...
                                <div class="row mb-4 d-flex align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control  @error('name') is-invalid @enderror"
                                               name="name" id="nameLabel" aria-label="Name"
                                               autocomplete="off"
                                               value="{{ $category->name }}">
                                        @error('name')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label class="form-check form-check-dashed" for="logoUploader" id="content_img">
                                        <img id="contentImg"
                                             ...
                                             src="{{ getFile(optional($category)->category_image_driver, optional($category)->category_image) }}"
