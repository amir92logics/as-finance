                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.basic.control.update') }}" method="post">
                                ...
                                @if($basicControl->vat_status)
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <label for="vatLabel" class="form-label">@lang('Vat')</label>

                                            <div class="input-group mb-3">
                                                <input type="number"  name="vat" id="vatLabel"  value="{{ old('vat',$basicControl->vat+0) }}" class="form-control  @error('vat') is-invalid @enderror" placeholder="Vat" aria-label="Vat" step="0.01" >
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="instructionsLabel" class="form-label">@lang('Order invoice instruction')</label>

                                        <div class="input-group mb-3">
                                            <input type="text"  name="instructions" id="vatLabel"  value="{{ old('instructions',$basicControl->instructions) }}" class="form-control  @error('instructions') is-invalid @enderror" placeholder="Instructions" aria-label="Instructions"  >
                                            <span class="input-group-text" id="basic-addon2">%</span>
                                        </div>
                                        @error('instructions')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h5 class="mb-0">@lang('Vat Status')</h5>
                                                        <span
                                                            class="d-block fs-6 text-body">@lang('If you want to enable vat system in your site then turn on this button.')</span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="row form-check form-switch" for="currencyPosition">
                                                <span class="col-4 col-sm-3 text-end">
                                                    <input type='hidden' value='0' name='vat_status'>
                                                        <input
                                                            class="form-check-input @error('vat_status') is-invalid @enderror"
                                                            type="checkbox"
                                                            name="vat_status"
                                                            id="vat_status"
                                                            value="1" {{($basicControl->vat_status == "1") ? 'checked' : ''}}>
                                                    </span>
                                                            @error('vat_status')
                                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                                            @enderror
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <h5 class="mb-0">@lang('Ecommerce Status')</h5>
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('If you want to enable E-commerce shop in your site then turn on this button.')</span>
                                                </div>
                                                <div class="col-auto">
                                                ...
                                                <span class="col-4 col-sm-3 text-end">
                                                    <input type='hidden' value='0' name='ecommerce_status'>
                                                        <input
                                                            class="form-check-input @error('ecommerce_status') is-invalid @enderror"
                                                            type="checkbox"
                                                            name="ecommerce_status"
                                                            id="ecommerce_status"
                                                            value="1" @checked($basicControl->ecommerce)>
                                                    </span>
                                                        @error('ecommerce_status')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                        @enderror
                                                    </label>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <h5 class="mb-0">@lang('Automatic Payout Permission')</h5>
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('If you want to enable automatic payout then turn on this button.')</span>
                                                </div>
                                                <div class="col-auto">
                                                    <label class="row form-check form-switch" for="automatic_payout_permission">
                                                <span class="col-4 col-sm-3 text-end">
                                                    <input type='hidden' value='0' name='automatic_payout_permission'>
                                                        <input
                                                            class="form-check-input @error('automatic_payout_permission') is-invalid @enderror"
                                                            type="checkbox"
                                                            name="automatic_payout_permission"
                                                            id="automatic_payout_permission"
                                                            value="1" @checked($basicControl->automatic_payout_permission)>
                                                    </span>
                                                        @error('automatic_payout_permission')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                        @enderror
                                                    </label>
