...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{ route('admin.product.coupon.store') }}" method="POST">
            @csrf
                        ...
                        <div class="card-body">
                            <div id="coupon_form">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="d-flex">
                                            <input type="text" placeholder="Coupon code" id="code" name="coupon_code"
                                                   class="form-control coupon_code w-75 me-3"
                                                   value="{{ old('coupon_code') }}" autocomplete="off">
                                            <button class="generateBtn btn btn-sm btn-success"
                                                    type="button">@lang('Generate code')</button>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" placeholder="Minimum Order Price" id="minimum_order_price"
                                               name="minimum_order_price"
                                               class="form-control" value="{{ old('minimum_order_price') }}"
                                               autocomplete="off">
                                        <div class="invalid-feedback d-inline-block">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group mb-3 custom">
                                            <input type="text" id="filter_date_range" name="expiration_validity"
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group mb-3">
                                            <input type="number" placeholder="Discount" name="discount"
                                                   value="{{ old('discount') }}" class="form-control me-2">
                                            <select
                                                class="js-select form-select @error('discount_type') is-invalid @enderror"
                                                name="discount_type" id="discount_type">
                                                <option class="" value="Fixed">@lang('Amount')</option>
                                                <option class="" value="Percent">@lang('Percent')</option>
                                            </select>
                                            <div class="invalid-feedback d-inline-block">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" placeholder="Maximum Order" id="maximum_order"
                                               name="maximum_order"
                                               class="form-control" value="{{ old('maximum_order') }}"
                                               autocomplete="off">
                                        <div class="invalid-feedback d-inline-block">
                                        ...
                                        <div class="tom-select-custom tom-select-custom-with-tags">
                                            <select class="js-select form-select" name="applicable_products[]" autocomplete="off" multiple
                                                ...
                                                @foreach($products as $product)
                                                    <option value="{{$product->id}}">{{optional($product->details)->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
