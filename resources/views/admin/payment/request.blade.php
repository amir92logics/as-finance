                                            ...
                                            <div class="col-12 mb-4">
                                                ...
                                                <div class="tom-select-custom">
                                                    <select class="js-select form-select" id="filter_method">
                                                        <option value="all"
                                                                data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="{{ asset("assets/upload/payoutMethod/withdraw.png") }}" alt="..." /><span class="text-truncate">@lang("All Gateway")</span></span>'
        ...
        $(document).on('ready', function () {
            ...
            $(document).on("click", '.edit_btn', function (e) {
                ...
                if($(this).data('detailsinfo')){
                    details =  Object.entries($(this).data('detailsinfo'));
                }
