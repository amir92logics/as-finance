...
<div class="js-nav-scroller hs-nav-scroller-horizontal mb-5">
    ...
    <ul class="nav nav-tabs align-items-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('admin.user.payout') ? 'active' : '' }}"
               href="{{ route('admin.user.payout', $user->id) }}">@lang('Withdraw History')
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('admin.user.plan.invest.history') ? 'active' : '' }}"
               href="{{ route('admin.user.plan.invest.history', $user->id) }}">@lang('Plan Invest History')</a>
        </li>
        <li class="nav-item">
