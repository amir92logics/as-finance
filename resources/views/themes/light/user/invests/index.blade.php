...
@section('title',trans('Invests'))
@section('content')
    <div class="pagetitle">
        <h3 class="mb-1">@lang('Invests')</h3>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('user.dashboard')}}">@lang('Home')</a></li>
                <li class="breadcrumb-item active">@lang('Invests')</li>
            </ol>
        </nav>
    </div>
                        ...
                        @foreach($projects as $key => $project)
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{route('project.details',optional($project->details)->slug)??'project-details'}}" class="btn-1"><i class="fal fa-eye"></i> @lang('View') <span></span></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
